...
async function main() {
  ...
  // Recipe 1: Chocolat à base de baie de goji
  ...
  // Recipe 2: Chocolat à la poudre d'amande
  ...
  // Recipe 3: Chocolat sucré à la stévia avec une pincée de sel
  ...
  console.log(
    `Database has been seeded with ${await prisma.recipe.count()} recipes`
  );
}
